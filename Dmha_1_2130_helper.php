<?php
    ...
    // Admin Control status perkawinan
    // data_1_2130();
    function data_1_2130_order_by_nama_asc(){
        // ------------------------------------------------------------------------- INITIALIZE
            $isi = '';
            $isi_model = data_2130::read_data_order_by_nama_asc();
            $counter = 0;
            ...
            if(count($isi_model) > 0){
                foreach ($isi_model as $row) {
                    ...
                    $isi .= '<tr>';
                        ...
                        $isi .= generate_dropdown_button('2130',$row->id);
                        $isi .= '</td>';
                    $isi .= '</tr>';
                }
            }else{
