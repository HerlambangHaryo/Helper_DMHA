<?php
    ...
    // data_1_0006();
    function read_accordion_data_1_0006($AUTH_MAS,$DMHA_ID){
        // ------------------------------------------------------------------------- INITIALIZE
            $isi        = '';            
            $counter    = 0;         
            $isi_model  = data_0006::read_data_order_by_asc($DMHA_ID);
        ...
        // ------------------------------------------------------------------------- ACTION
            if(count($isi_model) > 0)
            {
                foreach ($isi_model as $row) 
                {
                    ...
                    $isi .= read_table_data_1_0006($AUTH_MAS,$row->dmha_id);
    ...
    function read_table_data_1_0006($AUTH_MAS,$PARENT_ID){
        // ------------------------------------------------------------------------- INITIALIZE
            $isi = '';
            $jumlah_kolom = 3;
            $isi_model  = data_0006::read_data_order_by_asc($PARENT_ID);
